...
#gm convert -size 512x512 "$dir/../gui/images/bluetracky.png" "$tmp/bluetracky.png"
convert "$dir/../gui/images/bluetracky.png" -filter triangle -resize 512x512 "$tmp/bluetracky.png"

# Build iconset 
mkdir "$tmp/$APPNAME.iconset" 
sips -z 16 16     "$tmp/bluetracky.png" --out "$tmp/$APPNAME.iconset/icon_16x16.png" 
sips -z 32 32     "$tmp/bluetracky.png" --out "$tmp/$APPNAME.iconset/icon_16x16@2x.png" 
sips -z 32 32     "$tmp/bluetracky.png" --out "$tmp/$APPNAME.iconset/icon_32x32.png" 
sips -z 64 64     "$tmp/bluetracky.png" --out "$tmp/$APPNAME.iconset/icon_32x32@2x.png" 
sips -z 128 128   "$tmp/bluetracky.png" --out "$tmp/$APPNAME.iconset/icon_128x128.png" 
sips -z 256 256   "$tmp/bluetracky.png" --out "$tmp/$APPNAME.iconset/icon_128x128@2x.png" 
sips -z 512 512   "$tmp/bluetracky.png" --out "$tmp/$APPNAME.iconset/icon_256x256@2x.png" 
sips -z 512 512   "$tmp/bluetracky.png" --out "$tmp/$APPNAME.iconset/icon_512x512.png" 
